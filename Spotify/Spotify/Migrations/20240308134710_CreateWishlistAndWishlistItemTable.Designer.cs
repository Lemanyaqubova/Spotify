...
namespace Spotify.Migrations
{
    ...
    [Migration("20240308134710_CreateWishlistAndWishlistItemTable")]
    partial class CreateWishlistAndWishlistItemTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotify.Models.Comment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spotify.Models.Rating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spotify.Models.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spotify.Models.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Spotify.Models.Rating", b =>
                {
                    b.HasOne("Spotify.Models.Comment", "Comment")
                        .WithOne("Rating")
                        .HasForeignKey("Spotify.Models.Rating", "CommentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Spotify.Models.WishlistItem", b =>
                {
                    ...
                    b.HasOne("Spotify.Models.Wishlist", "Wishlist")
                        .WithMany("WishlistItems")
